...
declare function ComboboxItem({
  ...
  children,
  ...props
}: ComboboxPrimitive.Item.Props): import("react/jsx-runtime").JSX.Element;
...
declare function ComboboxCollection({
  ...props
}: ComboboxPrimitive.Collection.Props): import("react/jsx-runtime").JSX.Element;
...
declare function ComboboxChips({
  ...
  ComboboxPrimitive.Chips.Props): import("react/jsx-runtime").JSX.Element;
...
declare function ComboboxChipsInput({
  className,
  ...props
}: ComboboxPrimitive.Input.Props): import("react/jsx-runtime").JSX.Element;
